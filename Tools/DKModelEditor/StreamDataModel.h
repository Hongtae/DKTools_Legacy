...
class StreamDataModel : public wxDataViewModel
{
public:
	enum DataViewColumn
	{
		...
		DataViewColumnId,
		DataViewColumnType,
		DataViewColumnComponent,
		DataViewColumnNormalize,
		DataViewColumnMax,
	};

	StreamDataModel(void)
	{
		...
		dataViewColumns.Add(new wxDataViewColumn("Component", new wxDataViewTextRenderer("string", wxDATAVIEW_CELL_EDITABLE, wxDVR_DEFAULT_ALIGNMENT), DataViewColumnComponent, 80, wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE));
		dataViewColumns.Add(new wxDataViewColumn("Normalize", new wxDataViewTextRenderer("string", wxDATAVIEW_CELL_EDITABLE, wxDVR_DEFAULT_ALIGNMENT), DataViewColumnNormalize, 80, wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE));
	}
	~StreamDataModel(void)
	{
	}
